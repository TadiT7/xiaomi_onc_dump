...
INSERT INTO qcril_emergency_source_escv_nw_table VALUES('466','05','110',0);

DELETE FROM qcril_emergency_source_escv_nw_table WHERE MCC = '466' AND MNC = '05' AND NUMBER = '112';
INSERT INTO qcril_emergency_source_escv_nw_table VALUES('466','05','112',2);

DELETE FROM qcril_emergency_source_escv_nw_table WHERE MCC = '466' AND MNC = '05' AND NUMBER = '119';
INSERT INTO qcril_emergency_source_escv_nw_table VALUES('466','05','119',1);
